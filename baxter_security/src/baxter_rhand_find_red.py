...
class RedDetect:
	...
	def callback(self, data):
		...
		cv_imageThresh = cv2.inRange(cv_imageHSV, np.array((80,80,200)), np.array((90,256,256))) # Convert the HSV image to binary, getting red
		...
		# Finds the largest red shape as the lighter
		for cnt in contour:

...
from kinect_cam.msg import KinectCoords
...
class BlueDetect:
	...
	def callback(self, data):
		...
		cv_imageThresh = cv2.inRange(cv_imageHSV, np.array((110, 60, 200)), np.array((120,256,256))) # Convert the HSV image to binary, getting blue
